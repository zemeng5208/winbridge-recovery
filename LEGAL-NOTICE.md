...
WinBridge Recovery is an independent, non-commercial student project created for learning, authorized testing, and helping Windows users recover local plugin state.

- The author is not affiliated with, employed by, sponsored by, or endorsed by OpenAI.
- OpenAI, ChatGPT, GPT, Codex, and related product names and marks belong to their respective owner.
...
If a rights holder identifies material that should be changed or removed, please open an issue with enough detail to locate it.
